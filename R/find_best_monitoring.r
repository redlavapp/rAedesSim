...
#' @param i_biocointaner object: rAedesSim object concerning \code{biocointaner} object used in simulation.  
...
#' @param stocastic logical: if stocastic simulation by \code{biomel} are carried out in simulation.Defalut is True.
#' @param n_sampling numeric: number  of resampling if stochastic is implemented. Default is 10.
...
find_best_monitoring=function ( i_meteo,
				...
				stocastic=TRUE,
			        n_sampling=10,
			        inibition=FALSE) {
>>>>>>> c3b9c348363a16c45f1149ad12f81baf21deb857
