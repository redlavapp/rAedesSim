...
biofitmodel  <- function(i_biometeo,
			 ...
			 plotresults=FALSE
				...
				if ( plotresults == TRUE) {plot(simul_ts[[best]],
                                              main = paste("Observed (red) & Assessed (Black) - ",as.character(i_biocontainer$type),"-","Stage's competivity index: Larvae=",replies_best[1],"   Adults=",replies_best[1],"   Larval MaxDensity=",
                                                              replies_best[3]),
				                              cex.axis = 1.2,
							      cex.main = 2.5,
